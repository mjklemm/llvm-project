...
OpenMPIRBuilder::InsertPointTy OpenMPIRBuilder::emitTargetTask(
  ...
  if (OutlinedFnID) {
    ...
    // TODO do we need to do anything here for ompx_bare kernel language calls?
...
static void emitTargetCall(
    ...
    Constant *OutlinedFnID, ArrayRef<Value *> NumTeams,
    ArrayRef<Value *> NumThreads, SmallVectorImpl<Value *> &Args,
...
OpenMPIRBuilder::InsertPointTy OpenMPIRBuilder::createTarget(
    ...
    ArrayRef<Value *> NumTeams, ArrayRef<Value *> NumThreads,
